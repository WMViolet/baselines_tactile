...
from envs.gym.envs.box2d.car_dynamics import Car
from envs.gym.utils import colorize, seeding, EzPickle
...
class CarRacing(gym.Env, EzPickle):
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            from envs.gym.envs.classic_control import rendering
