...
from envs.gym.envs.robotics.utils import robot_get_obs, process_data
...
class ManipulateEnv(hand_env.HandEnv):
    def __init__(
        ...
        ignore_z_target_rotation=False, obs_type = 'original', fixed_num_of_contact = [5, True],
    ):
        ...
        self.object_indices = [46]
        self.obs_type = obs_type
        self.fixed_num_of_contact = fixed_num_of_contact[0]
        self.permute = fixed_num_of_contact[1]
        # print("********")
        # print("********")
        # print(self.permute)
        # print("********")
        # print("********")
        # full: 'object_loc+rot+joint+contact_loc+force+other'
        self.include_object_loc = 'object_loc' in self.obs_type
        self.include_object_rot = 'rot' in self.obs_type
        self.include_full_object = self.include_object_loc and self.include_object_rot

        self.include_geoms = 'geom' in self.obs_type
        self.include_force = 'force' in self.obs_type
        self.include_position = 'contact_loc' in self.obs_type
        self.include_contact = self.include_force or self.include_geoms or self.include_position
        ...
        self.contact_dim = (self.sim.model.ngeom * self.include_geoms + 3 * self.include_position + 6 * self.include_force) * self.fixed_num_of_contact
    ...
    def _get_obs(self):
        ...
        if self.include_full_object:
            ...
            observation = np.concatenate([robot_qpos, robot_qvel, object_qvel, achieved_goal[-4:]])
        ...
        if self.include_contact:
            ...
            processed, valid_contact_num = process_data(total_num_of_geoms,
                                     num_of_contacts,
                                     geom1s,
                                     geom2s,
                                     geom1_names,
...
class HandBlockEnv(ManipulateEnv, utils.EzPickle):
    def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse', obs_type = 'original', fixed_num_of_contact = 0):
        ...
        ManipulateEnv.__init__(self,
            ...
            reward_type=reward_type, obs_type = obs_type,
