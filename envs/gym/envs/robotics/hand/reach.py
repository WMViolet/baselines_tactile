...
from envs.gym.envs.robotics import hand_env
...
class HandReachEnv(hand_env.HandEnv, utils.EzPickle):
    def __init__(
        ...
        initial_qpos=DEFAULT_INITIAL_QPOS, reward_type='sparse', obs_type = 'original',
    ...
    def _get_obs(self):
        ...
        if self.obs_type == 'object':
            ...
            processed = utils.process_data(total_num_of_geoms,
                                     num_of_contacts,
                                     geom1s,
                                     geom2s,
                                     geom1_names,
